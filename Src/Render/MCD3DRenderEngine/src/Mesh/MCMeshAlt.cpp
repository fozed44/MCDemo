...
namespace MC {
	...
	*/
	...
	public:
		...
		const D3D12_VERTEX_BUFFER_VIEW* VertexBufferView() const noexcept { return &_vertexBufferView; }
		const D3D12_INDEX_BUFFER_VIEW*  IndexBufferView()  const noexcept { return &_indexBufferView; }
	...
	protected:
		...
		DXGI_FORMAT _indexFormat = INDEX_FORMAT;
